...
namespace Precisamento.MonoGame.MathHelpers
{
    public static class Vector2Ext
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform(Vector2[] sourceArray, int sourceIndex, ref Matrix2 matrix, Vector2[] destinationArray, int destinationIndex, int length)
        {
        ...
        /// <param name="destinationArray">Destination array.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Transform(Vector2[] sourceArray, ref Matrix2 matrix, Vector2[] destinationArray)
        {
